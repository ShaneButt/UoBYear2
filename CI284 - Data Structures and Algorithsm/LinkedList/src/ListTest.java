public class ListTest {
    public static void main(String[] args)
    {
        ...
        Ticket shane = new Ticket("Shane Butt", "Software Issue", "Michael Jordan", 1, 3);
        Ticket jack = new Ticket("Jack Whitchurch", "Network Issue","PB J Sarnies", 2, 3);
        Ticket marc = new Ticket("Marc Walker", "Data Issue","Fusili McPasta", 3, 2);
        Ticket mollie = new Ticket("Mollie Applebee", "Application Crash", "Jane Doe", 4, 1);
